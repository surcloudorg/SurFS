		...
		<li class="dropdown" id="user-menu"><a title="" href="#"
			...
			<ul class="dropdown-menu">
				...
				<li><a href="javascript:showPool()"><i class="icon-hdd"></i>
						存储池管理</a></li>
				<li class="divider"></li>
				<li><a href="javascript:showExport()"><i class="icon-upload-alt"></i>
						导出管理</a></li>
			</ul>
		</li>
...
function logout() {
	showSubmit("${path}/block/logout.do");
}

function showPool() {
	showSubmit("${path}/block/showPool.do");
}

function showExport() {
	showSubmit("${path}/block/showExport.do");
}

function showBlockUser(){
	showSubmit("${path}/block/showBlockUser.do");
}
