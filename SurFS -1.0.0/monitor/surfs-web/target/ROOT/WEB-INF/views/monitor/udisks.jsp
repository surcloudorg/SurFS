									...
									<div class="widget-content">
										<c:forEach var="mapList" items="${mmList.value}">
											<table class="table table-bordered table-striped">
												<thead>
													<tr>
														<th colspan="4">pool名称：${mapList.key}</th>
													</tr>
													<tr>
														<th style="width: 400px;">JbodId</th>
														<th style="width: 300px;">面板位置</th>
														<th style="width: 200px;">盘位</th>
														<th>设备名称</th>
													</tr>
												</thead>
												<c:forEach var="disk" items="${mapList.value}">
													<tr>
														<td>${disk.jbodId}</td>
														<td>
															<c:if test="${disk.panel == 'f'}">前面板</c:if>
															<c:if test="${disk.panel == 'b'}">后面板</c:if>
														</td>
														<td>${disk.disk}</td>
														<td>${disk.devName}</td>
													</tr>
