...
public abstract class TcpCommandDecoder extends Thread {
    ...
    private static final Logger log = LogFactory.getLogger(TcpCommandDecoder.class);
    ...
    public long readLong() throws IOException {
        ...
        if (curBuffer.remaining() >= 8) {
            ...
            byte[] bs = readBytes(8);
            return com.autumn.util.Function.byte2long(bs);
        }
    }
    ...
    public int readInt() throws IOException {
        ...
        if (curBuffer.remaining() >= 4) {
            ...
            byte[] bs = readBytes(4);
            return com.autumn.util.Function.byte2int(bs);
        }
    }
