...
<br/> 	 				                   </td>
          ...
          <tr>
			...
			<c:if test="${menwatch.accessPermission>1}"><input name="clear" type="submit" class="bottonbox" id="clear"  onclick="return(confirm('确认操作！'))" value="回收内存" /></c:if>
			<span class="redtitle"><c:out value="${menwatch.doMsg}"/></span></td>
          </tr>
        </tbody>
      </table>  
	  </td>
