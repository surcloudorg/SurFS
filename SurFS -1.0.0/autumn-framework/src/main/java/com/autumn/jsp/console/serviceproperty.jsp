...
<br />
	  ...
	  <table cellspacing="0" cellpadding="0" width="100%" align="center"
        ...
        <tbody>
          ...
          <tr>
            <td height="23" colspan="2" align="left" valign="middle" nowrap="nowrap" background="../img/pub/top1.gif">&nbsp;&nbsp;<c:out value='${smsrv.id}'/>-<c:out value='${smsrv.title}'/></td>
            </tr>
            
            <c:forEach items="${smsrv.serviceConfig.properties}" var="mapItem"> 
          <tr>
          ...
          <tr>
            <td height="23" align="right" valign="middle" nowrap="nowrap" bgcolor="#EEEEEE"  background="../img/pub/top1.gif">&nbsp;
              <input type="hidden" name="id" id="id" value="<c:out value='${smsrv.id}'/>" />
              &nbsp;
              <c:if test="${smsrv.accessPermission>1}">
              <input name="dotype" type="submit" class="bottonbox" id="dotype" value="设置属性" /></c:if> 
            </td>
            <td  align="left" valign="middle" nowrap="nowrap" background="../img/pub/top1.gif">&nbsp;&nbsp;
            &nbsp;<c:if test="${smsrv.accessPermission>1}"><input name="dotype" type="submit" class="bottonbox" id="dotype" value="保存属性" /></c:if> &nbsp;&nbsp;
            &nbsp;<input class="bottonbox" type="submit" value="返回" name="Submit11" />
            <span class="redtitle">
              <c:out value="${smsrv.doMsg}"/>
