    ...
    <tr>
      <td
            height="25" valign="bottom" background="../img/pub/content_top_bg.jpg">&nbsp;&nbsp;<strong><img
                  ...
                  align="absmiddle" /> 执行方法-<c:out value='${smsrv.id}'/>-<c:out value='${smsrv.title}'/></strong></td>
    </tr>
    <tr>
      <td valign="top" height="500">
	  <br/>
      <c:forEach items="${smsrv.serviceConfig.methods}" var="mapItem"> 
        ...
        <tbody>
          ...
          <tr>
            <td height="23" colspan="2" align="left" valign="middle" nowrap="nowrap" background="../img/pub/top1.gif">&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <input name="dotype" type="submit" class="bottonbox" id="button" value="呼叫此方法" /></c:if> 
              <input type="hidden" name="statuMsg" value="<c:out value='${mapItem.methodName}'/>" />
...
<input class="bottonbox" type="submit" value="返回" name="Submit11" />
            ...
            <c:if test="${smsrv.statuMsg==mapItem.methodName}">
            <c:forEach items="${smsrv.rows}" var="mysrv">
           <tr>
