    ...
    <tr>
      <td
            height="25" valign="bottom" background="../img/pub/content_top_bg.jpg">&nbsp;&nbsp;<strong><img
                  ...
                  align="absmiddle" /> 执行方法-<c:out value='${smsoap.id}'/>-<c:out value='${smsoap.title}'/></strong></td>
    </tr>
    <tr>
      <td valign="top" height="500">
	  <br/>
      <c:forEach items="${smsoap.soapConfig.methods}" var="mapItem"> 
        ...
        <tbody>
          ...
          <tr>
            <td height="23" colspan="2" align="left" valign="middle" nowrap="nowrap" background="../img/pub/top1.gif">&nbsp;&nbsp;&nbsp;&nbsp;
              <c:if test="${smsoap.accessPermission>1}"><input name="dotype" type="submit" class="bottonbox" id="button" value="呼叫此方法" /></c:if>
...
<input class="bottonbox" type="submit" value="返回" name="Submit11" />
            ...
            <c:if test="${smsoap.className==mapItem.methodName}">
