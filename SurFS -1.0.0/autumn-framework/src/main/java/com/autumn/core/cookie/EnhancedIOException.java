 ...
 * <code>IEnhancedException</code> interface, and subclass of
 * <code>java.io.IOException</code>.<p> Setter methods for the error code,
 * causal Exception, class and method of origin, and data Object are provided.
 * However, once these fields have been set, any subsequent calls to the
 * respective setters throws an
...
public class EnhancedIOException extends java.io.IOException implements IEnhancedException {
    ...
    private static final long serialVersionUID = 20120701000006L;
     ...
     * @throws UnsupportedOperationException	Thrown if the data Object has
     * already been set.
     */
     ...
     * @throws UnsupportedOperationException	Thrown if the error code has
     * already been set.
     */
    public final void setCode(String c) throws UnsupportedOperationException {
        if (bCodeSet) {
     ...
     * parameter is itself an instance of
     * <code>Class</code>, then the class of origin is taken as o.getName().
     *
     * @param o	the Object representing the class of origin.
     * @throws UnsupportedOperationException	Thrown if the class of origin has
     * already been set.
     * @see java.lang.Class
     */
    public final void setOriginClass(Object o) throws UnsupportedOperationException {
        if (bClassSet) {
     ...
     * @throws UnsupportedOperationException	Thrown if the method of origin has
     * already been set.
     */
    public final void setOriginMethod(String meth) throws UnsupportedOperationException {
        if (bMethodSet) {
     ...
     * @throws UnsupportedOperationException	Thrown if the causal Exception has
     * already been set.
     */
    public final void setCausalException(Exception e) throws UnsupportedOperationException {
        if (bCausalSet) {
     ...
     * <code>IOException.toString()</code>. Otherwise, the returned String is
     * formed by concatenating the following :-<br> <ul> <li>The name of the
     * actual class of this object </li> <li>": " (a colon and a space) </li>
     * <li>The result of the {@link #getMessage} method for this object</li>
     * <li>" : Code="</li> <li>The error-code</li> <li>" : OriginClass="</li>
     * <li>The class of origin</li> <li>" : OriginMethod="</li> <li>The method
     * of origin</li> <li>" : CausalException="</li> <li>The name of the class
     * of the causal Exception (if any)</li> </ul>
     *
     * @return	the
     ...
     * parameter is itself an instance of
     * <code>Class</code>, then the class of origin is taken as o.getName().
     * Allows subclasses to have unrestricted access to "class of origin" field.
     *
     * @param o	the Object representing the class of origin.
     * @see java.lang.Class
     */
